...
int main () {       //Aquí empieza nuestro programa 
    ...
    float base , high , calculo;      // Creamos la variable nombrada base y high con su data type int , para guardar la base y altura  del triángulo. 
...
// std::cin >> base >> high ; std::cin >> base , high ; !!! Importante . 
